...
<br />
<sup>7</sup>HEVC decoding is only supported on Windows 10/11 with the <a href="https://www.microsoft.com/store/productId/9NMZLZ57R3T7">HEVC Video Extensions</a> from the Microsoft store.
<br />
...
<br />
<sup>13</sup>HEVC software decoding is supported with the installtion of <a href="https://www.microsoft.com/store/productId/9NMZLZ57R3T7">HEVC Video Extensions</a> from the Microsoft store. HEVC hardware decoding is supported if device has hardware acceleration dedicated for HEVC.
